...
const togetherPhotos = [
  { id: 1, src: '/birthday/photos/together1.jpeg', caption: 'Proof that we actually meet sometimes.' },
  { id: 2, src: '/birthday/photos/together2.jpeg', caption: 'One of the rare moments both of us looked at the camera.' },
  { id: 3, src: '/birthday/photos/together3.jpeg', caption: 'National treasure. Protected by friendship laws.' },
  { id: 4, src: '/birthday/photos/together4.jpeg', caption: 'Limited edition. Only 4 exist in the world.' },
];
